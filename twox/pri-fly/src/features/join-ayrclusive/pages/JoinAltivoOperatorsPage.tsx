  ...
  return (
    <main className="w-full">
      ...
      <JoinHero
        ...
        description="Ayrclusive connects verified aircraft operators with brokers who need reliable charter solutions. Join a trusted network built around speed, transparency, and operational confidence."
      />
      ...
      <DocumentUploadForm
        ...
        description="Provide your operational documentation so the Ayrclusive team can verify your company and aircraft eligibility."
