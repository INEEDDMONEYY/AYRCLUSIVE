...
export default function JoinAltivoBrokersPage() {
  return (
    <main className="w-full">
      ...
      <JoinHero
        eyebrow="Join AYRCLUSIVE Brokers"
        title="Grow your charter business with a trusted operator network."
        description="
          Ayrclusive connects aviation brokers with verified operators,
      ...
      <BenefitsGrid
        ...
        heading="Grow your charter business with AYRCLUSIVE"
      ...
      <DocumentUploadForm
        ...
        description="Provide your business and brokerage documentation so the Ayrclusive team can verify your company and grant marketplace access."
