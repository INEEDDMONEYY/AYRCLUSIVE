...
import OperatorRoute from "./guards/OperatorRoute";
...
import WhyAltivoOperatorsPage from "../features/why-ayrclusive/pages/WhyAltivoOperatorsPage";
...
import JoinAltivoPage from "../features/join-ayrclusive/pages/JoinAltivoPage";
import JoinAltivoBrokersPage from "../features/join-ayrclusive/pages/JoinAltivoBrokersPage";
import JoinAltivoOperatorsPage from "../features/join-ayrclusive/pages/JoinAltivoOperatorsPage";
  ...
  return (
    <Routes>
      ...
      <Route element={<MainLayout />}>
        ...
        <Route path="/why-ayrclusive" element={<WhyAltivoPage />} />
        <Route path="/why-ayrclusive/brokers" element={<WhyAltivoBrokersPage />} />
        <Route path="/why-ayrclusive/operators" element={<WhyAltivoOperatorsPage />} />
        ...
        <Route path="/join-ayrclusive" element={<JoinAltivoPage />} />
        <Route path="/join-ayrclusive/brokers" element={<JoinAltivoBrokersPage />} />
        <Route path="/join-ayrclusive/operators" element={<JoinAltivoOperatorsPage />} />
